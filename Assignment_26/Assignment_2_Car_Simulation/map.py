...
Config.set('graphics', 'width', '1432')
...
class Game(Widget):
    ...
    def serve_car(self):
        print('Self center ', self.goal1.center)
        self.car.center = self.goal1.center
    ...
    def update(self, dt):
        ...
        self.goal1.pos = (360,340)
        self.goal2.pos = (1205,42)
        self.goal3.pos = (1315,515)
